  ...
  return (
    <section className="mr-72 mt-20">
      <div className="flex items-center justify-center ">
        <div
          className="relative flex h-96 w-[500px] items-center justify-center bg-cover bg-center shadow-lg shadow-[#39D5FF]"
          style={{ backgroundImage: "url('/assets/bola3d.jpg')" }}
        >
          <p className="text-center text-4xl font-bold text-white opacity-0 transition-opacity duration-300 hover:opacity-100">
            “Os maiores jogadores começaram como você. Treine duro, mantenha a
            determinação e alcance seus objetivos!”
          </p>
        </div>

        <div
          className="novidades-flex relative h-96 w-[1000px] bg-cover bg-center p-14 "
        ...
        >
          ...
          <p className="absolute bottom-4 right-4 z-10 text-2xl font-bold">
            FUTEBOL
          </p>
        </div>
      </div>
