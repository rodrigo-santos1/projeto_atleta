...
const Footer = () => {
  return (
    <footer className="relative mt-20 flex w-full items-center justify-between overflow-hidden border-t-2 border-[#39D5FF] bg-[#1b402c] p-6">
        ...
        {/* Links de navegação */}
        <div className="relative z-10 hidden ms-20 gap-8 text-white md:flex">
          <a href="/sobre" className="transition-colors hover:text-[#39D5FF]">
            Sobre
          </a>
          <a
            href="/politica"
            className="transition-colors hover:text-[#39D5FF]"
          >
        ...
        <div className="relative z-10 mb-4 text-center justify-center text-white sm:mb-0">
          <p>
        ...
        <div className="relative z-10 flex me-40 gap-6 sm:gap-4">
          <a
