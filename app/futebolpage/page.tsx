...
export default function ProductPage() {
  ...
  return (
    <div className="min-h-screen bg-[#080F1A] text-[#39D5FF]">
      ...
      >
        <p className="text-4xl font-bold text-[#39D5FF]">Futebol</p>
      </div>
                  ...
                  <CardContent>
                    <Link href={`/product/${product.id}`}>
                      <div className="relative">
                        ...
                        <Button
                          variant="outline"
                          className="absolute right-2 top-2 rounded-full border-[#39D5FF] bg-[#2a5c40] p-2 text-[#39D5FF] hover:bg-[#39D5FF] hover:text-[#FFFFFF]"
                          onClick={(e) => {
                            e.preventDefault();
