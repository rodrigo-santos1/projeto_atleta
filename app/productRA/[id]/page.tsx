...
export default function ProductDetailPage() {
  ...
  const [product, setProduct] = useState<ARProduct | undefined>(undefined); // Alterado para ARProduct
  ...
  useEffect(() => {
    const fetchProduct = () => {
      const foundProduct = arProducts.find((p) => p.id === params.id); // Alterado para buscar em arProducts
      ...
      <div className="container mx-auto p-4">
        <header className="mb-6 flex items-center justify-between">
          <Link href="/" className="flex items-center text-3xl font-bold">
            ...
            <span className="text-white">Realidade Aumentada</span>
          </Link>
